            ...
            <div class="col-12 col-lg-10 offset-lg-1 col-xl-3 offset-xl-2">
                ...
                <form class="mt-4" action="" @submit.prevent="sendEmail">
                    ...
                    <div class="form-group mb-3">
                        <input v-model="name" class="form-control py-2" type="text" name="name" id="name" placeholder="Bedrijfsnaam*" autocomplete="off" required>
                    </div>
                    <div class="form-group mb-3">
                        <input v-model="email" class="form-control py-2" type="email" name="email" id="email" placeholder="E-mail*" autocomplete="off" required>
                    </div>
                    <div class="form-group mb-3">
                        <input v-model="phone" class="form-control py-2" type="text" name="phone" id="phone" placeholder="Telefoonnummer*" autocomplete="off">
                    </div>
                    <div class="form-group mb-3">
                        <textarea v-model="message" class="form-control py-2" name="message" id="message" placeholder="Bericht" autocomplete="off" required rows="7"></textarea>
                    </div>
